        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <fieldset class="form-group"> <!-- profession -->
                    ...
                    <input type="text" class="form-control" id="exampleInput" name="profession">
            ...
            <div class="col-lg-4">
                <fieldset class="form-group"> <!-- address -->
                    ...
                    <input type="text" class="form-control" id="exampleInput" name="address">
            ...
            <div class="col-lg-4">
                <fieldset class="form-group"> <!-- nationality -->
                    ...
                    <input type="text" class="form-control" id="exampleInput" name="nationality">
            ...
            <div class="col-lg-4">
                <fieldset class="form-group"> <!-- phone -->
                    ...
                    <input type="text" class="form-control" id="exampleInput" name="phone">
            ...
            <div class="col-lg-4">
                <fieldset class="form-group"> <!-- birth date -->
                    ...
                    <input type="text" class="form-control" id="date-mask-input" placeholder="__/__/____" name="birth">
